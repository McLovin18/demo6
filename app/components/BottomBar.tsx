...
export default function BottomBar({ role = "admin" }) {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 w-full flex overflow-x-auto z-50 text-white" style={{backgroundColor: "var(--color-navy-premium)", borderColor: "var(--border)", borderTop: "1px solid var(--border)" }}>
